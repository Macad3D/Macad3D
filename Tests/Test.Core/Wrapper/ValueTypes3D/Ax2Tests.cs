...
namespace Macad.Test.Core.Wrapper.ValueTypes3D;

[TestFixture]
public class Ax2Tests
{
    [Test]
    public void Origins()
    {
    ...
    {
        var p1 = new Ax2(new Pnt(1, 2, 3), new Dir(1, 0, 0));
    ...
    {
        var p1 = new Ax2(new Pnt(1, 2, 3), new Dir(1, 0, 0));
        var p2 = new Ax2(new Pnt(2, 3, 4), new Dir(0, 1, 0));
    ...
    public void MirrorPnt()
    {
        ...
        var p2 = new Ax2(new Pnt(1, 2, 3), new Dir(1, 0, 0));
    ...
    {
        var res = new Ax2(new Pnt(1, -2, -3), new Dir(1, 0, 0), new Dir(0, 0, -10));
    ...
    public void Rotate()
    {
        var res = new Ax2(new Pnt(1, 1, 2), new Dir(1, 0, 0), new Dir(0, -1, 0));
    ...
    public void Scale()
    {
        var res = new Ax2(new Pnt(-1, 0, 5), new Dir(1, 0, 0));
        var p2 = new Ax2(new Pnt(1, 2, 3), new Dir(1, 0, 0));
    ...
    {
        var res = new Ax2(new Pnt(-1, -1, 2), new Dir(1, 0, 0));
        var p2 = new Ax2(new Pnt(1, 2, 3), new Dir(1, 0, 0));
    ...
    {
        var res = new Ax2(new Pnt(3, 5, 4), new Dir(1, 0, 0));
        var p2 = new Ax2(new Pnt(1, 2, 3), new Dir(1, 0, 0));
