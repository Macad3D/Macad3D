...
public class SerializerTests
{
    ...
    public void SetUp()
    {
        Serializer.RegisterNamespaceAlias("Test", "Macad.Test.Core.Serialization");
    }
    ...
    {
        var alias = Serializer.ApplyNamespaceAlias("Macad.Test.Core.Serialization.MyNamespace.MyClass");
        Assert.AreEqual("Test.MyNamespace.MyClass", alias);

        var full = Serializer.ResolveNamespaceAlias(alias);
        Assert.AreEqual("Macad.Test.Core.Serialization.MyNamespace.MyClass", full);
    }
