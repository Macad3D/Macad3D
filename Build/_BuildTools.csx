...
{
    public const int VisualStudioRelease = 18;
    public const string DotNetRelease = "10.0";
    ...
    bool _FindVSInstance()
    {
        ...
        var commandLine = $"-version [{VisualStudioRelease}.0,{VisualStudioRelease + 1}.0) -latest -property installationPath -requires {string.Join(" ", _RequiredComponents)}";
        ...
        Printer.Error("Required installation of VisualStudio 2026 not found.");
