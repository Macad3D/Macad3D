...
public static class MouseHorizontalWheelEnabler
{
    ...
    public static void EnableMouseHorizontalWheelSupport([NotNull] System.Windows.Controls.Primitives.Popup popup) {
        if (popup == null) {
    ...
    /// <returns>True if it was disabled or already disabled, false if it couldn't be disabled.</returns>
    public static bool DisableMouseHorizontalWheelSupport([NotNull] System.Windows.Controls.Primitives.Popup popup) {
        if (popup == null) {
            throw new ArgumentNullException(nameof(popup));
        }
    ...
    public static void EnableMouseHorizontalWheelSupportForParentOf(UIElement uiElement) {
        ...
        if (uiElement is Window) {
            ...
            EnableMouseHorizontalWheelSupport((System.Windows.Controls.Primitives.Popup)uiElement);
        }
    ...
    private static void HandleMouseHorizontalWheel(IntPtr wParam) {
        ...
        if (!(element is UIElement)) {
            element = PresentationHelper.FindLogicalParent<UIElement>(element as DependencyObject);
        }
        if (element == null) {
            return;
        }
    ...
    public static readonly RoutedEvent MouseHorizontalWheelEvent =
        EventManager.RegisterRoutedEvent("MouseHorizontalWheel", RoutingStrategy.Bubble, typeof(MouseHorizontalWheelEventHandler),
