...
void AIS_RotationGizmo::Compute(const Handle(Prs3d_Projector)& aProjector, const Handle(Geom_Transformation)& aTransformation, const Handle(Prs3d_Presentation)& aPresentation)
{
...
void AIS_RotationGizmo::Compute(const Handle(Prs3d_Projector)&,
