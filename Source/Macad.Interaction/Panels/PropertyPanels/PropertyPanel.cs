...
public abstract class PropertyPanel : PanelBase, IDisposable
{
    ...
    protected void InitializeDescriptors()
    {
        ...
        DescriptorDimensionless0dp ??= new MeasurementDescriptor(UnitId.Number, 1);
        DescriptorDimensionlessPercentage1dp ??= new MeasurementDescriptor(UnitId.Percentage, 1);
