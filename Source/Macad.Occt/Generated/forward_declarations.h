...
namespace Occt
{
	...
	ref class Standard_ArrayStreamBuffer;
	...
	ref class TCollection_BaseSequence;
	ref class TCollection_BasicMap;
	ref class TCollection_MapNode;
	ref class TCollection_BasicMapIterator;
	...
	ref class Units_UtsSequence;
	ref class Units_QtsSequence;
	ref class Units_TksSequence;
	ref class Units_UnitsDictionary;
	ref class Units_Quantity;
	ref class Units_Lexicon;
	ref class Units_Dimensions;
	ref class Units_Unit;
	ref class Units_ShiftedUnit;
	ref class Units_Token;
	ref class Units_ShiftedToken;
	ref class Units_UnitsSystem;
	ref class Units_Explorer;
	ref class Units_Sentence;
	ref class Units_MathSentence;
	ref class Units_UnitSentence;
	ref class Units_UnitsLexicon;
	ref class Units_Measurement;
	ref class Units;
	ref class Units_UnitsSequence;
	ref class Units_QuantitiesSequence;
	ref class Units_TokensSequence;
	ref class Units_NoSuchType;
	ref class Units_NoSuchUnit;
	ref class UnitsAPI;
	...
	ref class Message_ArrayOfMsg;
	ref class Message_ListOfMsg;
	ref class Message_ListOfAlert;
	ref class Message_SequenceOfPrinters;
	ref class Message_SequenceOfProgressScale;
	ref class Message_Messenger;
	ref class Message_Msg;
	ref class Message_MsgFile;
	ref class Message_Algorithm;
	ref class Message_Printer;
	ref class Message_PrinterOStream;
	ref class Message_ProgressScale;
	ref class Message;
	ref class Message_Alert;
	ref class Message_ExecStatus;
	...
	ref class Adaptor2d_HCurve2d;
	ref class Adaptor2d_Curve2d;
	ref class Adaptor2d_Line2d;
	ref class Adaptor2d_HLine2d;
	ref class Adaptor2d_OffsetCurve;
	ref class Adaptor2d_HOffsetCurve;
	...
	ref class Geom2dAdaptor_GHCurve;
	ref class Geom2dAdaptor_HCurve;
	ref class Geom2dAdaptor;
	ref class Adaptor3d_HCurve;
	ref class Adaptor3d_Curve;
	ref class Adaptor3d_HSurface;
	ref class Adaptor3d_CurveOnSurface;
	ref class Adaptor3d_HCurveOnSurface;
	ref class Adaptor3d_IsoCurve;
	ref class Adaptor3d_HIsoCurve;
	...
	ref class GeomAdaptor_GHSurface;
	ref class GeomAdaptor_HSurface;
	ref class GeomAdaptor_GHCurve;
	ref class GeomAdaptor_HCurve;
	ref class GeomAdaptor;
	ref class GeomAdaptor_SurfaceOfLinearExtrusion;
	ref class GeomAdaptor_HSurfaceOfLinearExtrusion;
	ref class GeomAdaptor_SurfaceOfRevolution;
	ref class GeomAdaptor_HSurfaceOfRevolution;
	ref class TopAbs;
	ref class IntAna2d_IntPoint;
	ref class IntAna2d_Conic;
	ref class IntAna2d_AnaIntersection;
	ref class MyDirectPolynomialRoots;
	...
	ref class ProjLib_HProjectedCurve;
	ref class ProjLib_CompProjectedCurve;
	ref class ProjLib_HCompProjectedCurve;
	...
	ref class TopoDS;
	ref class TopoDS_AlertWithShape;
	...
	ref class BRepAdaptor_HCompCurve;
	ref class BRepAdaptor_HCurve;
	ref class BRepAdaptor_HCurve2d;
	ref class BRepAdaptor_Surface;
	ref class BRepAdaptor_HSurface;
	...
	ref class BRepCheck_DataMapOfShapeResult;
	...
	ref class BRepFeat;
	ref class ShapeAlgo_AlgoContainer;
	ref class ShapeAlgo_ToolContainer;
	ref class ShapeAlgo;
	...
	ref class ShapeCustom_RestrictionParameters;
	ref class ShapeCustom_Surface;
	ref class ShapeCustom_Curve;
	ref class ShapeCustom_Curve2d;
	ref class ShapeCustom_Modification;
	ref class ShapeCustom_DirectModification;
	ref class ShapeCustom_TrsfModification;
	ref class ShapeCustom_BSplineRestriction;
	ref class ShapeCustom_ConvertToRevolution;
	ref class ShapeCustom_SweptToElementary;
	...
	ref class ShapeExtend_BasicMsgRegistrator;
	ref class ShapeExtend_MsgRegistrator;
	ref class ShapeExtend_Explorer;
	ref class ShapeExtend;
	...
	ref class ShapeFix;
	ref class ShapeProcess_Operator;
	ref class ShapeProcess_Context;
	ref class ShapeProcess_ShapeContext;
	ref class ShapeProcess_UOperator;
	ref class ShapeProcess_OperLibrary;
	ref class ShapeProcess;
	ref class ShapeProcessAPI_ApplySequence;
	...
	ref class BRepOffset_ListOfInterval;
	ref class BRepOffset_DataMapOfShapeListOfInterval;
	ref class BRepOffset_DataMapOfShapeOffset;
	ref class BRepOffset;
	ref class BRepOffset_Interval;
	ref class BRepOffset_Analyse;
	ref class BRepOffset_Offset;
	ref class BRepOffset_Inter2d;
	ref class BRepOffset_Inter3d;
	ref class BRepOffset_MakeLoops;
	ref class BRepOffset_MakeOffset;
	ref class BRepOffset_MakeSimpleOffset;
	ref class BRepOffset_SimpleOffset;
	ref class BRepOffset_Tool;
	...
	ref class Aspect_DisplayConnection;
	...
	ref class Aspect_NeutralWindow;
	ref class Aspect_RectangularGrid;
	ref class Aspect_Touch;
	ref class Aspect_VKeySet;
	...
	ref class TColQuantity_Array1OfLength;
	ref class TColQuantity_Array2OfLength;
	ref class TColQuantity_HArray1OfLength;
	ref class TColQuantity_HArray2OfLength;
	ref class WNT_ClassDefinitionError;
	...
	ref class Graphic3d_AxisAspect;
	...
	ref class Graphic3d_TransformError;
	...
	ref class Graphic3d_Texture2Dmanual;
	...
	ref class StdSelect_Prs;
	ref class StdSelect_Shape;
	ref class StdSelect;
	ref class StdSelect_ViewerSelector3d;
	...
	ref class Prs3d_Projector;
	ref class Prs3d_ShapeTool;
	...
	ref class AIS_Relation;
	ref class AIS_Chamf2dDimension;
	ref class AIS_Chamf3dDimension;
	ref class AIS_Circle;
	ref class AIS_ColoredDrawer;
	ref class AIS_Shape;
	ref class AIS_ColoredShape;
	ref class AIS_ConcentricRelation;
	ref class AIS_ConnectedInteractive;
	ref class AIS_DiameterDimension;
	ref class AIS_EllipseRadiusDimension;
	ref class AIS_EqualDistanceRelation;
	ref class AIS_EqualRadiusRelation;
	ref class AIS_ExclusionFilter;
	ref class AIS_FixRelation;
	ref class AIS_GraphicTool;
	ref class AIS_IdenticRelation;
	ref class AIS_LengthDimension;
	ref class AIS_Line;
	ref class AIS_ManipulatorObjectSequence;
	ref class AIS_ManipulatorOwner;
	ref class AIS_MaxRadiusDimension;
	ref class AIS_MediaPlayer;
	ref class AIS_MidPointRelation;
	ref class AIS_MinRadiusDimension;
	ref class AIS_MultipleConnectedInteractive;
	ref class AIS_OffsetDimension;
	ref class AIS_ParallelRelation;
	ref class AIS_PerpendicularRelation;
	ref class AIS_Plane;
	ref class AIS_Point;
	ref class AIS_PlaneTrihedron;
	ref class AIS_PointCloud;
	ref class AIS_PointCloudOwner;
	ref class AIS_RadiusDimension;
	ref class AIS_RubberBand;
	ref class AIS_TypeFilter;
	ref class AIS_SignatureFilter;
	ref class AIS_SymmetricRelation;
	ref class AIS_TangentRelation;
