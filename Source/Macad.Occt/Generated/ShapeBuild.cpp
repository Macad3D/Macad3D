...
Macad::Occt::ShapeBuild_Vertex::ShapeBuild_Vertex()
	: BaseClass<::ShapeBuild_Vertex>(BaseClass::InitMode::Uninitialized)
{
...
Macad::Occt::ShapeBuild_Edge::ShapeBuild_Edge()
	: BaseClass<::ShapeBuild_Edge>(BaseClass::InitMode::Uninitialized)
{
...
void Macad::Occt::ShapeBuild_Edge::RemovePCurve(Macad::Occt::TopoDS_Edge^ edge, Macad::Occt::Geom_Surface^ surf)
{
	...
	((::ShapeBuild_Edge*)_NativeInstance)->RemovePCurve(*(::TopoDS_Edge*)edge->NativeInstance, h_surf);
...
{
	Handle(::Geom_Surface) h_surf = surf->NativeInstance;
	((::ShapeBuild_Edge*)_NativeInstance)->RemovePCurve(*(::TopoDS_Edge*)edge->NativeInstance, h_surf, *(::TopLoc_Location*)loc->NativeInstance);
	surf->NativeInstance = h_surf.get();
}
...
{
	Handle(::Geom2d_Curve) h_pcurve = pcurve->NativeInstance;
	((::ShapeBuild_Edge*)_NativeInstance)->ReplacePCurve(*(::TopoDS_Edge*)edge->NativeInstance, h_pcurve, *(::TopoDS_Face*)face->NativeInstance);
	pcurve->NativeInstance = h_pcurve.get();
}
...
{
	return ((::ShapeBuild_Edge*)_NativeInstance)->ReassignPCurve(*(::TopoDS_Edge*)edge->NativeInstance, *(::TopoDS_Face*)old->NativeInstance, *(::TopoDS_Face*)sub->NativeInstance);
}
...
Macad::Occt::Geom2d_Curve^ Macad::Occt::ShapeBuild_Edge::TransformPCurve(Macad::Occt::Geom2d_Curve^ pcurve, Macad::Occt::Trsf2d trans, double uFact, double% aFirst, double% aLast)
{
	...
	_result = ((::ShapeBuild_Edge*)_NativeInstance)->TransformPCurve(h_pcurve, *(gp_Trsf2d*)pp_trans, uFact, *(Standard_Real*)pp_aFirst, *(Standard_Real*)pp_aLast);
	pcurve->NativeInstance = h_pcurve.get();
...
{
	return ((::ShapeBuild_Edge*)_NativeInstance)->BuildCurve3d(*(::TopoDS_Edge*)edge->NativeInstance);
}
...
void Macad::Occt::ShapeBuild_Edge::MakeEdge(Macad::Occt::TopoDS_Edge^ edge, Macad::Occt::Geom_Curve^ curve, Macad::Occt::TopLoc_Location^ L)
{
	...
	((::ShapeBuild_Edge*)_NativeInstance)->MakeEdge(*(::TopoDS_Edge*)edge->NativeInstance, h_curve, *(::TopLoc_Location*)L->NativeInstance);
...
{
	Handle(::Geom_Curve) h_curve = curve->NativeInstance;
	((::ShapeBuild_Edge*)_NativeInstance)->MakeEdge(*(::TopoDS_Edge*)edge->NativeInstance, h_curve, *(::TopLoc_Location*)L->NativeInstance, p1, p2);
	curve->NativeInstance = h_curve.get();
}
...
{
	Handle(::Geom2d_Curve) h_pcurve = pcurve->NativeInstance;
	((::ShapeBuild_Edge*)_NativeInstance)->MakeEdge(*(::TopoDS_Edge*)edge->NativeInstance, h_pcurve, *(::TopoDS_Face*)face->NativeInstance);
	pcurve->NativeInstance = h_pcurve.get();
}
...
{
	Handle(::Geom2d_Curve) h_pcurve = pcurve->NativeInstance;
	((::ShapeBuild_Edge*)_NativeInstance)->MakeEdge(*(::TopoDS_Edge*)edge->NativeInstance, h_pcurve, *(::TopoDS_Face*)face->NativeInstance, p1, p2);
	pcurve->NativeInstance = h_pcurve.get();
}
...
void Macad::Occt::ShapeBuild_Edge::MakeEdge(Macad::Occt::TopoDS_Edge^ edge, Macad::Occt::Geom2d_Curve^ pcurve, Macad::Occt::Geom_Surface^ S, Macad::Occt::TopLoc_Location^ L)
{
	...
	((::ShapeBuild_Edge*)_NativeInstance)->MakeEdge(*(::TopoDS_Edge*)edge->NativeInstance, h_pcurve, h_S, *(::TopLoc_Location*)L->NativeInstance);
	pcurve->NativeInstance = h_pcurve.get();
...
void Macad::Occt::ShapeBuild_Edge::MakeEdge(Macad::Occt::TopoDS_Edge^ edge, Macad::Occt::Geom2d_Curve^ pcurve, Macad::Occt::Geom_Surface^ S, Macad::Occt::TopLoc_Location^ L, double p1, double p2)
{
	Handle(::Geom2d_Curve) h_pcurve = pcurve->NativeInstance;
	Handle(::Geom_Surface) h_S = S->NativeInstance;
	((::ShapeBuild_Edge*)_NativeInstance)->MakeEdge(*(::TopoDS_Edge*)edge->NativeInstance, h_pcurve, h_S, *(::TopLoc_Location*)L->NativeInstance, p1, p2);
	pcurve->NativeInstance = h_pcurve.get();
	S->NativeInstance = h_S.get();
}
...
{
	return ((::ShapeBuild_ReShape*)_NativeInstance)->Status(*(::TopoDS_Shape*)shape->NativeInstance, *(::TopoDS_Shape*)newsh->NativeInstance, last);
}

int Macad::Occt::ShapeBuild_ReShape::Status(Macad::Occt::TopoDS_Shape^ shape, Macad::Occt::TopoDS_Shape^ newsh)
{
	return ((::ShapeBuild_ReShape*)_NativeInstance)->Status(*(::TopoDS_Shape*)shape->NativeInstance, *(::TopoDS_Shape*)newsh->NativeInstance, false);
}

bool Macad::Occt::ShapeBuild_ReShape::Status(Macad::Occt::ShapeExtend_Status status)
{
	return ((::ShapeBuild_ReShape*)_NativeInstance)->Status((::ShapeExtend_Status)status);
}
...
Macad::Occt::ShapeBuild::ShapeBuild()
	: BaseClass<::ShapeBuild>(BaseClass::InitMode::Uninitialized)
{
