...
{
	return System::IntPtr(((::BRepPrimAPI_MakeCone*)_NativeInstance)->OneAxis());
}
...
{
	return System::IntPtr(((::BRepPrimAPI_MakeCylinder*)_NativeInstance)->OneAxis());
}
...
{
	return ((::BRepPrimAPI_MakePrism*)_NativeInstance)->IsDeleted(*(::TopoDS_Shape*)S->NativeInstance);
}
...
{
	return ((::BRepPrimAPI_MakeRevol*)_NativeInstance)->IsDeleted(*(::TopoDS_Shape*)S->NativeInstance);
}
...
{
	return ((::BRepPrimAPI_MakeRevol*)_NativeInstance)->HasDegenerated();
}
...
Macad::Occt::BRepPrimAPI_MakeRevolution::BRepPrimAPI_MakeRevolution(Macad::Occt::Geom_Curve^ Meridian)
	: Macad::Occt::BRepPrimAPI_MakeOneAxis(BaseClass::InitMode::Uninitialized)
{
	Handle(::Geom_Curve) h_Meridian = Meridian->NativeInstance;
	_NativeInstance = new ::BRepPrimAPI_MakeRevolution(h_Meridian);
	Meridian->NativeInstance = h_Meridian.get();
}
...
{
	Handle(::Geom_Curve) h_Meridian = Meridian->NativeInstance;
	_NativeInstance = new ::BRepPrimAPI_MakeRevolution(h_Meridian, angle);
	Meridian->NativeInstance = h_Meridian.get();
}
...
{
	Handle(::Geom_Curve) h_Meridian = Meridian->NativeInstance;
	_NativeInstance = new ::BRepPrimAPI_MakeRevolution(h_Meridian, VMin, VMax);
	Meridian->NativeInstance = h_Meridian.get();
}
...
{
	Handle(::Geom_Curve) h_Meridian = Meridian->NativeInstance;
	_NativeInstance = new ::BRepPrimAPI_MakeRevolution(h_Meridian, VMin, VMax, angle);
	Meridian->NativeInstance = h_Meridian.get();
}
	...
	: Macad::Occt::BRepPrimAPI_MakeOneAxis(BaseClass::InitMode::Uninitialized)
{
	pin_ptr<Macad::Occt::Ax2> pp_Axes = &Axes;
	Handle(::Geom_Curve) h_Meridian = Meridian->NativeInstance;
	_NativeInstance = new ::BRepPrimAPI_MakeRevolution(*(gp_Ax2*)pp_Axes, h_Meridian);
	Meridian->NativeInstance = h_Meridian.get();
}
	...
	: Macad::Occt::BRepPrimAPI_MakeOneAxis(BaseClass::InitMode::Uninitialized)
{
	pin_ptr<Macad::Occt::Ax2> pp_Axes = &Axes;
	Handle(::Geom_Curve) h_Meridian = Meridian->NativeInstance;
	_NativeInstance = new ::BRepPrimAPI_MakeRevolution(*(gp_Ax2*)pp_Axes, h_Meridian, angle);
	Meridian->NativeInstance = h_Meridian.get();
}
	...
	: Macad::Occt::BRepPrimAPI_MakeOneAxis(BaseClass::InitMode::Uninitialized)
{
	pin_ptr<Macad::Occt::Ax2> pp_Axes = &Axes;
	Handle(::Geom_Curve) h_Meridian = Meridian->NativeInstance;
	_NativeInstance = new ::BRepPrimAPI_MakeRevolution(*(gp_Ax2*)pp_Axes, h_Meridian, VMin, VMax);
	Meridian->NativeInstance = h_Meridian.get();
}
	...
	: Macad::Occt::BRepPrimAPI_MakeOneAxis(BaseClass::InitMode::Uninitialized)
{
	pin_ptr<Macad::Occt::Ax2> pp_Axes = &Axes;
	Handle(::Geom_Curve) h_Meridian = Meridian->NativeInstance;
	_NativeInstance = new ::BRepPrimAPI_MakeRevolution(*(gp_Ax2*)pp_Axes, h_Meridian, VMin, VMax, angle);
	Meridian->NativeInstance = h_Meridian.get();
}
...
{
	return System::IntPtr(((::BRepPrimAPI_MakeRevolution*)_NativeInstance)->OneAxis());
}
...
{
	return System::IntPtr(((::BRepPrimAPI_MakeSphere*)_NativeInstance)->OneAxis());
}
...
{
	return System::IntPtr(((::BRepPrimAPI_MakeTorus*)_NativeInstance)->OneAxis());
}
