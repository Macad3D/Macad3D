...
public:
	...
	/// </summary>
	/// <param name="theOwners">
	/// [in] elements to change selection state
	/// </param>
	/// <param name="theSelScheme">
	/// [in] selection scheme, defines how owner is selected
	/// </param>
	/// <param name="theToAllowSelOverlap">
	/// [in] selection flag, if true - overlapped entities are allowed
	/// </param>
	/// <param name="theFilter">
	/// [in] context filter to skip not acceptable owners
	/// </param>
...
public:
	...
	/// </summary>
	/// <returns>
	/// points for the rubber band polygon.
	/// </returns>
