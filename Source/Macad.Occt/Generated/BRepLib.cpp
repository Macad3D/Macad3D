...
void Macad::Occt::BRepLib_CheckCurveOnSurface::Perform(bool isMultiThread)
{
	((::BRepLib_CheckCurveOnSurface*)_NativeInstance)->Perform(isMultiThread);
}
...
Macad::Occt::BRepLib_ValidateEdge::BRepLib_ValidateEdge(Macad::Occt::Adaptor3d_Curve^ theReferenceCurve, Macad::Occt::Adaptor3d_CurveOnSurface^ theOtherCurve, bool theSameParameter)
	: BaseClass<::BRepLib_ValidateEdge>(BaseClass::InitMode::Uninitialized)
{
...
void Macad::Occt::BRepLib_ValidateEdge::SetExitIfToleranceExceeded(double theToleranceForChecking)
{
	((::BRepLib_ValidateEdge*)_NativeInstance)->SetExitIfToleranceExceeded(theToleranceForChecking);
}
...
{
	return ((::BRepLib_ValidateEdge*)_NativeInstance)->IsDone();
}

bool Macad::Occt::BRepLib_ValidateEdge::CheckTolerance(double theToleranceToCheck)
{
	return ((::BRepLib_ValidateEdge*)_NativeInstance)->CheckTolerance(theToleranceToCheck);
}

double Macad::Occt::BRepLib_ValidateEdge::GetMaxDistance()
{
	return ((::BRepLib_ValidateEdge*)_NativeInstance)->GetMaxDistance();
}
...
void Macad::Occt::BRepLib_ValidateEdge::UpdateTolerance(double% theToleranceToUpdate)
{
	...
	((::BRepLib_ValidateEdge*)_NativeInstance)->UpdateTolerance(*(Standard_Real*)pp_theToleranceToUpdate);
}
