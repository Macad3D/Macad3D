...
Macad::Occt::BRepTools_ShapeSet::BRepTools_ShapeSet(bool isWithTriangles)
	: Macad::Occt::TopTools_ShapeSet(BaseClass::InitMode::Uninitialized)
{
	_NativeInstance = new ::BRepTools_ShapeSet(isWithTriangles);
}

Macad::Occt::BRepTools_ShapeSet::BRepTools_ShapeSet(Macad::Occt::BRep_Builder^ B, bool isWithTriangles)
	: Macad::Occt::TopTools_ShapeSet(BaseClass::InitMode::Uninitialized)
{
	_NativeInstance = new ::BRepTools_ShapeSet(*(::BRep_Builder*)B->NativeInstance, isWithTriangles);
}

Macad::Occt::BRepTools_ShapeSet::BRepTools_ShapeSet(Macad::Occt::BRep_Builder^ B)
	: Macad::Occt::TopTools_ShapeSet(BaseClass::InitMode::Uninitialized)
{
	_NativeInstance = new ::BRepTools_ShapeSet(*(::BRep_Builder*)B->NativeInstance, true);
}
...
Macad::Occt::TopoDS_Shape^ Macad::Occt::BRepTools_ReShape::Apply(Macad::Occt::TopoDS_Shape^ shape, Macad::Occt::TopAbs_ShapeEnum until)
{
	::TopoDS_Shape* _result = new ::TopoDS_Shape();
	*_result = ((::BRepTools_ReShape*)_NativeInstance)->Apply(*(::TopoDS_Shape*)shape->NativeInstance, (::TopAbs_ShapeEnum)until);
	 return _result==nullptr ? nullptr : gcnew Macad::Occt::TopoDS_Shape(_result);
}

Macad::Occt::TopoDS_Shape^ Macad::Occt::BRepTools_ReShape::Apply(Macad::Occt::TopoDS_Shape^ shape)
{
	::TopoDS_Shape* _result = new ::TopoDS_Shape();
	*_result = ((::BRepTools_ReShape*)_NativeInstance)->Apply(*(::TopoDS_Shape*)shape->NativeInstance, TopAbs_SHAPE);
	 return _result==nullptr ? nullptr : gcnew Macad::Occt::TopoDS_Shape(_result);
}
...
void Macad::Occt::BRepTools::Clean(Macad::Occt::TopoDS_Shape^ S)
{
	::BRepTools::Clean(*(::TopoDS_Shape*)S->NativeInstance);
}
