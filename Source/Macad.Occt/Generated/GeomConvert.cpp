...
Macad::Occt::GeomConvert_ApproxSurface::GeomConvert_ApproxSurface(Macad::Occt::Adaptor3d_HSurface^ Surf, double Tol3d, Macad::Occt::GeomAbs_Shape UContinuity, Macad::Occt::GeomAbs_Shape VContinuity, int MaxDegU, int MaxDegV, int MaxSegments, int PrecisCode)
	: BaseClass<::GeomConvert_ApproxSurface>(BaseClass::InitMode::Uninitialized)
{
	Handle(::Adaptor3d_HSurface) h_Surf = Surf->NativeInstance;
	_NativeInstance = new ::GeomConvert_ApproxSurface(h_Surf, Tol3d, (::GeomAbs_Shape)UContinuity, (::GeomAbs_Shape)VContinuity, MaxDegU, MaxDegV, MaxSegments, PrecisCode);
	Surf->NativeInstance = h_Surf.get();
}
...
Macad::Occt::GeomConvert_ApproxCurve::GeomConvert_ApproxCurve(Macad::Occt::Adaptor3d_HCurve^ Curve, double Tol3d, Macad::Occt::GeomAbs_Shape Order, int MaxSegments, int MaxDegree)
	: BaseClass<::GeomConvert_ApproxCurve>(BaseClass::InitMode::Uninitialized)
{
