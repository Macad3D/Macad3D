...
Macad::Occt::Adaptor2d_Curve2d^ Macad::Occt::Adaptor2d_Curve2d::ShallowCopy()
{
	...
	_result = ((::Adaptor2d_Curve2d*)_NativeInstance)->ShallowCopy();
...
{
	Handle(::Adaptor2d_Curve2d) _result;
	_result = ((::Adaptor2d_Line2d*)_NativeInstance)->ShallowCopy();
	 return _result.IsNull() ? nullptr : Macad::Occt::Adaptor2d_Curve2d::CreateDowncasted( _result.get());
}
	...
	: Macad::Occt::Adaptor2d_Curve2d(BaseClass::InitMode::Uninitialized)
{
	...
	NativeInstance = new ::Adaptor2d_OffsetCurve(h_C);
...
{
	Handle(::Adaptor2d_Curve2d) h_C = C->NativeInstance;
	NativeInstance = new ::Adaptor2d_OffsetCurve(h_C, Offset);
	C->NativeInstance = h_C.get();
}
...
{
	Handle(::Adaptor2d_Curve2d) h_C = C->NativeInstance;
	NativeInstance = new ::Adaptor2d_OffsetCurve(h_C, Offset, WFirst, WLast);
	C->NativeInstance = h_C.get();
}
...
{
	Handle(::Adaptor2d_Curve2d) _result;
	_result = ((::Adaptor2d_OffsetCurve*)_NativeInstance)->ShallowCopy();
	 return _result.IsNull() ? nullptr : Macad::Occt::Adaptor2d_Curve2d::CreateDowncasted( _result.get());
}

void Macad::Occt::Adaptor2d_OffsetCurve::Load(Macad::Occt::Adaptor2d_Curve2d^ S)
{
	Handle(::Adaptor2d_Curve2d) h_S = S->NativeInstance;
