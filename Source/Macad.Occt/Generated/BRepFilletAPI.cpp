...
{
	return ((::BRepFilletAPI_LocalOperation*)_NativeInstance)->NbContours();
}

int Macad::Occt::BRepFilletAPI_LocalOperation::Contour(Macad::Occt::TopoDS_Edge^ E)
{
	return ((::BRepFilletAPI_LocalOperation*)_NativeInstance)->Contour(*(::TopoDS_Edge*)E->NativeInstance);
}

int Macad::Occt::BRepFilletAPI_LocalOperation::NbEdges(int I)
{
	return ((::BRepFilletAPI_LocalOperation*)_NativeInstance)->NbEdges(I);
}
...
{
	return ((::BRepFilletAPI_LocalOperation*)_NativeInstance)->Length(IC);
}
...
{
	return ((::BRepFilletAPI_LocalOperation*)_NativeInstance)->Abscissa(IC, *(::TopoDS_Vertex*)V->NativeInstance);
}

double Macad::Occt::BRepFilletAPI_LocalOperation::RelativeAbscissa(int IC, Macad::Occt::TopoDS_Vertex^ V)
{
	return ((::BRepFilletAPI_LocalOperation*)_NativeInstance)->RelativeAbscissa(IC, *(::TopoDS_Vertex*)V->NativeInstance);
}

bool Macad::Occt::BRepFilletAPI_LocalOperation::ClosedAndTangent(int IC)
{
	return ((::BRepFilletAPI_LocalOperation*)_NativeInstance)->ClosedAndTangent(IC);
}

bool Macad::Occt::BRepFilletAPI_LocalOperation::Closed(int IC)
{
	return ((::BRepFilletAPI_LocalOperation*)_NativeInstance)->Closed(IC);
}
...
{
	return ((::BRepFilletAPI_LocalOperation*)_NativeInstance)->NbSurf(IC);
}
...
void Macad::Occt::BRepFilletAPI_MakeChamfer::GetDist(int IC, double% Dis)
{
	...
	((::BRepFilletAPI_MakeChamfer*)_NativeInstance)->GetDist(IC, *(Standard_Real*)pp_Dis);
}
...
void Macad::Occt::BRepFilletAPI_MakeChamfer::Dists(int IC, double% Dis1, double% Dis2)
{
	...
	((::BRepFilletAPI_MakeChamfer*)_NativeInstance)->Dists(IC, *(Standard_Real*)pp_Dis1, *(Standard_Real*)pp_Dis2);
}
...
void Macad::Occt::BRepFilletAPI_MakeChamfer::GetDistAngle(int IC, double% Dis, double% Angle)
{
	...
	((::BRepFilletAPI_MakeChamfer*)_NativeInstance)->GetDistAngle(IC, *(Standard_Real*)pp_Dis, *(Standard_Real*)pp_Angle);
}

bool Macad::Occt::BRepFilletAPI_MakeChamfer::IsSymetric(int IC)
{
	return ((::BRepFilletAPI_MakeChamfer*)_NativeInstance)->IsSymetric(IC);
}

bool Macad::Occt::BRepFilletAPI_MakeChamfer::IsTwoDistances(int IC)
{
	return ((::BRepFilletAPI_MakeChamfer*)_NativeInstance)->IsTwoDistances(IC);
}

bool Macad::Occt::BRepFilletAPI_MakeChamfer::IsDistanceAngle(int IC)
{
	return ((::BRepFilletAPI_MakeChamfer*)_NativeInstance)->IsDistanceAngle(IC);
}
...
{
	return ((::BRepFilletAPI_MakeChamfer*)_NativeInstance)->NbContours();
}

int Macad::Occt::BRepFilletAPI_MakeChamfer::Contour(Macad::Occt::TopoDS_Edge^ E)
{
	return ((::BRepFilletAPI_MakeChamfer*)_NativeInstance)->Contour(*(::TopoDS_Edge*)E->NativeInstance);
}

int Macad::Occt::BRepFilletAPI_MakeChamfer::NbEdges(int I)
{
	return ((::BRepFilletAPI_MakeChamfer*)_NativeInstance)->NbEdges(I);
}
...
{
	return ((::BRepFilletAPI_MakeChamfer*)_NativeInstance)->Length(IC);
}
...
{
	return ((::BRepFilletAPI_MakeChamfer*)_NativeInstance)->Abscissa(IC, *(::TopoDS_Vertex*)V->NativeInstance);
}

double Macad::Occt::BRepFilletAPI_MakeChamfer::RelativeAbscissa(int IC, Macad::Occt::TopoDS_Vertex^ V)
{
	return ((::BRepFilletAPI_MakeChamfer*)_NativeInstance)->RelativeAbscissa(IC, *(::TopoDS_Vertex*)V->NativeInstance);
}

bool Macad::Occt::BRepFilletAPI_MakeChamfer::ClosedAndTangent(int IC)
{
	return ((::BRepFilletAPI_MakeChamfer*)_NativeInstance)->ClosedAndTangent(IC);
}
...
{
	return ((::BRepFilletAPI_MakeChamfer*)_NativeInstance)->IsDeleted(*(::TopoDS_Shape*)F->NativeInstance);
}
...
{
	return ((::BRepFilletAPI_MakeChamfer*)_NativeInstance)->NbSurf(IC);
}
...
{
	return ((::BRepFilletAPI_MakeFillet*)_NativeInstance)->IsConstant(IC);
}

double Macad::Occt::BRepFilletAPI_MakeFillet::Radius(int IC)
{
	return ((::BRepFilletAPI_MakeFillet*)_NativeInstance)->Radius(IC);
}

bool Macad::Occt::BRepFilletAPI_MakeFillet::IsConstant(int IC, Macad::Occt::TopoDS_Edge^ E)
{
	return ((::BRepFilletAPI_MakeFillet*)_NativeInstance)->IsConstant(IC, *(::TopoDS_Edge*)E->NativeInstance);
}

double Macad::Occt::BRepFilletAPI_MakeFillet::Radius(int IC, Macad::Occt::TopoDS_Edge^ E)
{
	return ((::BRepFilletAPI_MakeFillet*)_NativeInstance)->Radius(IC, *(::TopoDS_Edge*)E->NativeInstance);
}
...
bool Macad::Occt::BRepFilletAPI_MakeFillet::GetBounds(int IC, Macad::Occt::TopoDS_Edge^ E, double% F, double% L)
{
	...
	return ((::BRepFilletAPI_MakeFillet*)_NativeInstance)->GetBounds(IC, *(::TopoDS_Edge*)E->NativeInstance, *(Standard_Real*)pp_F, *(Standard_Real*)pp_L);
}
...
{
	return (Macad::Occt::ChFi3d_FilletShape)((::BRepFilletAPI_MakeFillet*)_NativeInstance)->GetFilletShape();
}

int Macad::Occt::BRepFilletAPI_MakeFillet::NbContours()
{
	return ((::BRepFilletAPI_MakeFillet*)_NativeInstance)->NbContours();
}

int Macad::Occt::BRepFilletAPI_MakeFillet::Contour(Macad::Occt::TopoDS_Edge^ E)
{
	return ((::BRepFilletAPI_MakeFillet*)_NativeInstance)->Contour(*(::TopoDS_Edge*)E->NativeInstance);
}

int Macad::Occt::BRepFilletAPI_MakeFillet::NbEdges(int I)
{
	return ((::BRepFilletAPI_MakeFillet*)_NativeInstance)->NbEdges(I);
}
...
{
	return ((::BRepFilletAPI_MakeFillet*)_NativeInstance)->Length(IC);
}
...
{
	return ((::BRepFilletAPI_MakeFillet*)_NativeInstance)->Abscissa(IC, *(::TopoDS_Vertex*)V->NativeInstance);
}

double Macad::Occt::BRepFilletAPI_MakeFillet::RelativeAbscissa(int IC, Macad::Occt::TopoDS_Vertex^ V)
{
	return ((::BRepFilletAPI_MakeFillet*)_NativeInstance)->RelativeAbscissa(IC, *(::TopoDS_Vertex*)V->NativeInstance);
}

bool Macad::Occt::BRepFilletAPI_MakeFillet::ClosedAndTangent(int IC)
{
	return ((::BRepFilletAPI_MakeFillet*)_NativeInstance)->ClosedAndTangent(IC);
}
...
{
	return ((::BRepFilletAPI_MakeFillet*)_NativeInstance)->IsDeleted(*(::TopoDS_Shape*)F->NativeInstance);
}

int Macad::Occt::BRepFilletAPI_MakeFillet::NbSurfaces()
{
	return ((::BRepFilletAPI_MakeFillet*)_NativeInstance)->NbSurfaces();
}
...
{
	return ((::BRepFilletAPI_MakeFillet*)_NativeInstance)->NbSurf(IC);
}

int Macad::Occt::BRepFilletAPI_MakeFillet::NbFaultyContours()
{
	return ((::BRepFilletAPI_MakeFillet*)_NativeInstance)->NbFaultyContours();
}

int Macad::Occt::BRepFilletAPI_MakeFillet::FaultyContour(int I)
{
	return ((::BRepFilletAPI_MakeFillet*)_NativeInstance)->FaultyContour(I);
}

int Macad::Occt::BRepFilletAPI_MakeFillet::NbComputedSurfaces(int IC)
{
	return ((::BRepFilletAPI_MakeFillet*)_NativeInstance)->NbComputedSurfaces(IC);
}

Macad::Occt::Geom_Surface^ Macad::Occt::BRepFilletAPI_MakeFillet::ComputedSurface(int IC, int IS)
{
	Handle(::Geom_Surface) _result;
	_result = ((::BRepFilletAPI_MakeFillet*)_NativeInstance)->ComputedSurface(IC, IS);
...
{
	return ((::BRepFilletAPI_MakeFillet*)_NativeInstance)->NbFaultyVertices();
}
...
{
	return ((::BRepFilletAPI_MakeFillet*)_NativeInstance)->HasResult();
}
...
{
	return ((::BRepFilletAPI_MakeFillet2d*)_NativeInstance)->IsModified(*(::TopoDS_Edge*)E->NativeInstance);
}
...
{
	return ((::BRepFilletAPI_MakeFillet2d*)_NativeInstance)->NbFillet();
}
...
{
	return ((::BRepFilletAPI_MakeFillet2d*)_NativeInstance)->NbChamfer();
}
...
{
	return ((::BRepFilletAPI_MakeFillet2d*)_NativeInstance)->NbCurves();
}
...
{
	return ((::BRepFilletAPI_MakeFillet2d*)_NativeInstance)->HasDescendant(*(::TopoDS_Edge*)E->NativeInstance);
}
