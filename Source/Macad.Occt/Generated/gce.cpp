...
Macad::Occt::gce_Root::gce_Root()
	: BaseClass<::gce_Root>(BaseClass::InitMode::Uninitialized)
{
...
{
	return ((::gce_Root*)_NativeInstance)->IsDone();
}

Macad::Occt::gce_ErrorType Macad::Occt::gce_Root::Status()
{
	return (Macad::Occt::gce_ErrorType)((::gce_Root*)_NativeInstance)->Status();
}
...
{
	return Macad::Occt::Dir(((::gce_MakeDir*)_NativeInstance)->Value());
}

Macad::Occt::Dir Macad::Occt::gce_MakeDir::Operator()
{
	return Macad::Occt::Dir(((::gce_MakeDir*)_NativeInstance)->Operator());
}
...
{
	return Macad::Occt::Dir2d(((::gce_MakeDir2d*)_NativeInstance)->Value());
}

Macad::Occt::Dir2d Macad::Occt::gce_MakeDir2d::Operator()
{
	return Macad::Occt::Dir2d(((::gce_MakeDir2d*)_NativeInstance)->Operator());
}
...
Macad::Occt::gce_MakeMirror::gce_MakeMirror(Macad::Occt::Pnt Point)
	: BaseClass<::gce_MakeMirror>(BaseClass::InitMode::Uninitialized)
{
	pin_ptr<Macad::Occt::Pnt> pp_Point = &Point;
...
{
	return Macad::Occt::Trsf(((::gce_MakeMirror*)_NativeInstance)->Value());
}

Macad::Occt::Trsf Macad::Occt::gce_MakeMirror::Operator()
{
	return Macad::Occt::Trsf(((::gce_MakeMirror*)_NativeInstance)->Operator());
}
...
Macad::Occt::gce_MakeMirror2d::gce_MakeMirror2d(Macad::Occt::Pnt2d Point)
	: BaseClass<::gce_MakeMirror2d>(BaseClass::InitMode::Uninitialized)
{
	pin_ptr<Macad::Occt::Pnt2d> pp_Point = &Point;
...
{
	return Macad::Occt::Trsf2d(((::gce_MakeMirror2d*)_NativeInstance)->Value());
}

Macad::Occt::Trsf2d Macad::Occt::gce_MakeMirror2d::Operator()
{
	return Macad::Occt::Trsf2d(((::gce_MakeMirror2d*)_NativeInstance)->Operator());
}
...
{
	return Macad::Occt::Pln(((::gce_MakePln*)_NativeInstance)->Value());
}

Macad::Occt::Pln Macad::Occt::gce_MakePln::Operator()
{
	return Macad::Occt::Pln(((::gce_MakePln*)_NativeInstance)->Operator());
}
...
Macad::Occt::gce_MakeRotation::gce_MakeRotation(Macad::Occt::gp_Lin^ Line, double Angle)
	: BaseClass<::gce_MakeRotation>(BaseClass::InitMode::Uninitialized)
{
...
{
	return Macad::Occt::Trsf(((::gce_MakeRotation*)_NativeInstance)->Value());
}

Macad::Occt::Trsf Macad::Occt::gce_MakeRotation::Operator()
{
	return Macad::Occt::Trsf(((::gce_MakeRotation*)_NativeInstance)->Operator());
}
...
Macad::Occt::gce_MakeRotation2d::gce_MakeRotation2d(Macad::Occt::Pnt2d Point, double Angle)
	: BaseClass<::gce_MakeRotation2d>(BaseClass::InitMode::Uninitialized)
{
	pin_ptr<Macad::Occt::Pnt2d> pp_Point = &Point;
...
{
	return Macad::Occt::Trsf2d(((::gce_MakeRotation2d*)_NativeInstance)->Value());
}

Macad::Occt::Trsf2d Macad::Occt::gce_MakeRotation2d::Operator()
{
	return Macad::Occt::Trsf2d(((::gce_MakeRotation2d*)_NativeInstance)->Operator());
}
...
Macad::Occt::gce_MakeScale::gce_MakeScale(Macad::Occt::Pnt Point, double Scale)
	: BaseClass<::gce_MakeScale>(BaseClass::InitMode::Uninitialized)
{
	pin_ptr<Macad::Occt::Pnt> pp_Point = &Point;
...
{
	return Macad::Occt::Trsf(((::gce_MakeScale*)_NativeInstance)->Value());
}

Macad::Occt::Trsf Macad::Occt::gce_MakeScale::Operator()
{
	return Macad::Occt::Trsf(((::gce_MakeScale*)_NativeInstance)->Operator());
}
...
Macad::Occt::gce_MakeScale2d::gce_MakeScale2d(Macad::Occt::Pnt2d Point, double Scale)
	: BaseClass<::gce_MakeScale2d>(BaseClass::InitMode::Uninitialized)
{
	pin_ptr<Macad::Occt::Pnt2d> pp_Point = &Point;
...
{
	return Macad::Occt::Trsf2d(((::gce_MakeScale2d*)_NativeInstance)->Value());
}

Macad::Occt::Trsf2d Macad::Occt::gce_MakeScale2d::Operator()
{
	return Macad::Occt::Trsf2d(((::gce_MakeScale2d*)_NativeInstance)->Operator());
}
...
Macad::Occt::gce_MakeTranslation::gce_MakeTranslation(Macad::Occt::Vec Vect)
	: BaseClass<::gce_MakeTranslation>(BaseClass::InitMode::Uninitialized)
{
...
{
	return Macad::Occt::Trsf(((::gce_MakeTranslation*)_NativeInstance)->Value());
}

Macad::Occt::Trsf Macad::Occt::gce_MakeTranslation::Operator()
{
	return Macad::Occt::Trsf(((::gce_MakeTranslation*)_NativeInstance)->Operator());
}
...
Macad::Occt::gce_MakeTranslation2d::gce_MakeTranslation2d(Macad::Occt::Vec2d Vect)
	: BaseClass<::gce_MakeTranslation2d>(BaseClass::InitMode::Uninitialized)
{
...
{
	return Macad::Occt::Trsf2d(((::gce_MakeTranslation2d*)_NativeInstance)->Value());
}

Macad::Occt::Trsf2d Macad::Occt::gce_MakeTranslation2d::Operator()
{
	return Macad::Occt::Trsf2d(((::gce_MakeTranslation2d*)_NativeInstance)->Operator());
}
