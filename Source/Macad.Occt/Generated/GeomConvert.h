...
public:
	...
	GeomConvert_ApproxSurface(Macad::Occt::Adaptor3d_HSurface^ Surf, double Tol3d, Macad::Occt::GeomAbs_Shape UContinuity, Macad::Occt::GeomAbs_Shape VContinuity, int MaxDegU, int MaxDegV, int MaxSegments, int PrecisCode);
...
public:
	...
	GeomConvert_ApproxCurve(Macad::Occt::Adaptor3d_HCurve^ Curve, double Tol3d, Macad::Occt::GeomAbs_Shape Order, int MaxSegments, int MaxDegree);
