...
namespace Occt
{
	...
	ref class Message_Attribute;
	ref class Message_CompositeAlerts;
	ref class Message_AlertExtended;
	ref class Message_ExecStatus;
	ref class Message_Msg;
	ref class Message_Algorithm;
	ref class Message_AttributeMeter;
	ref class Message_AttributeObject;
	ref class Message_AttributeStream;
	ref class Message_Level;
	ref class Message_MsgFile;
	ref class Message_PrinterOStream;
	ref class Message_PrinterSystemLog;
	ref class Message_PrinterToReport;
	ref class Message_ProgressRange;
	ref class Message_ProgressScope;
	...
	ref class TopoDS;
	ref class TopoDS_AlertAttribute;
