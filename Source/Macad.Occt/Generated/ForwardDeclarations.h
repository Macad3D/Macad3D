...
namespace Occt
{
    ...
    ref class BRepFill_DataMapOfNodeDataMapOfShapeShape;
    ref class BRepFill_DataMapOfNodeShape;
    ref class BRepFill_DataMapOfOrientedShapeListOfShape;
    ref class BRepFill_DataMapOfShapeDataMapOfShapeListOfShape;
    ref class BRepFill_DataMapOfShapeHArray2OfShape;
    ref class BRepFill_DataMapOfShapeSequenceOfPnt;
    ref class BRepFill_DataMapOfShapeSequenceOfReal;
    ref class BRepFill_SequenceOfEdgeFaceAndOrder;
    ref class BRepFill_SequenceOfFaceAndOrder;
    ref class BRepFill_IndexedDataMapOfOrientedShapeListOfShape;
    ref class BRepFill_ListOfOffsetWire;
    ref class BRepFill_SequenceOfSection;
    ref class BRepFill;
    ref class BRepFill_LocationLaw;
    ref class BRepFill_ACRLaw;
    ref class BRepFill_AdvancedEvolved;
    ref class BRepFill_ApproxSeewing;
    ref class BRepFill_CompatibleWires;
    ref class BRepFill_ComputeCLine;
    ref class BRepFill_Edge3DLaw;
    ref class BRepFill_SectionLaw;
    ref class BRepFill_Draft;
    ref class BRepFill_DraftLaw;
    ref class BRepFill_EdgeFaceAndOrder;
    ref class BRepFill_EdgeOnSurfLaw;
    ref class BRepFill_Evolved;
    ref class BRepFill_FaceAndOrder;
    ref class BRepFill_Filling;
    ref class BRepFill_Generator;
    ref class BRepFill_TrimEdgeTool;
    ref class BRepFill_OffsetWire;
    ref class BRepFill_NSections;
    ref class BRepFill_OffsetAncestors;
    ref class BRepFill_Sweep;
    ref class BRepFill_Pipe;
    ref class BRepFill_Section;
    ref class BRepFill_PipeShell;
    ref class BRepFill_SectionPlacement;
    ref class BRepFill_ShapeLaw;
    ref class BRepFill_TrimShellCorner;
    ref class BRepFill_TrimSurfaceTool;
