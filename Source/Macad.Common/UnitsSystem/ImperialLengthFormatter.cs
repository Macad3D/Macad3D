...
public static class ImperialLengthFormatter
{
    ...
    public static string FormatDecimalInches(double inches, int decimals)
    {
    ...
    public static string FormatFractionalInches(double inches, int denominator)
    {
        ...
        int num = (int)Math.Round(frac * denominator);
        ...
        Reduce(ref num, ref denominator);
    ...
    public static string FormatArchitectural(double inches, int denominator)
    {
        bool negative = inches < 0;
        inches = Math.Abs(inches);
